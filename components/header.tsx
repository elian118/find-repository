...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 left-0 z-10 w-full bg-info">
      <div className="mx-auto md:max-w-screen-2xl min-h-12 px-4 flex flex-wrap justify-between items-center gap-4">
